<?php
$folder = "/0_dam/test1/uploads/images/";
...
$ig = '<img src="'.$folder.$filename.'" style="width:inherit;height:inherit">';

$sql = "insert into images(image_name,image) values('$filename','$ig')";
...
// $sql="select * from images order by desc";
// $result = mysqli_query($conn, $sql);
// $row  = mysqli_fetch_assoc($result);
// $img = $row['image_name'];
// exit(json_encode(['success' =>true, 'image' => "$img"]));